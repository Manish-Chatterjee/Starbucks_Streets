  ...
  return (
    <View style={{ backgroundColor: "#04643c" }}>
      <View style={styles.container}>
        ...
        <Image
          source={{
            uri: "https://liliebakery.fr/wp-content/uploads/2024/10/latte-macchiato-recette-facile-lilie-bakery.jpg",
          }}
          style={{
            width: 60,
            height: 60,
      ...
      <View style={styles.card}>
        <View style={{ alignItems: "center" }}>
          <Text style={{ fontWeight: "bold", color: "#04643c" }}>
            STARBUCKS REWARD
          </Text>
          <Text style={{ fontWeight: "bold", color: "#4c8b66" }}>
            Green Card
          </Text>
        </View>
        <View style={styles.cardText}>
          <Text style={{ fontSize: 28, fontWeight: "bold", color: "#04643c" }}>
            21{" "}
          </Text>
          <Text style={{ fontSize: 16, fontWeight: "bold", color: "#04643c" }}>
            / 100{" "}
          </Text>
        ...
        />
        <Text style={{ fontSize: 12, fontWeight: 600, color: "#04643c" }}>
          {stars} Stars to Next Reward
        </Text>
      </View>
