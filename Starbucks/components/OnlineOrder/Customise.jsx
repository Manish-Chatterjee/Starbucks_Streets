  ...
  useEffect(() => {
    ...
    setIsFormValid(
      isSizeSelected &&
        ...
        isMilkSelected &&
        isEspressoShotSelected,
    );
  }, [selectedSize, availableIn, milk, espressoShot]);

  // console.log("Mounted → Customise");
    ...
    <View style={{ backgroundColor: "white" }}>
        ...
        <View style={styles.container}>
          ...
          <View style={{ marginTop: 40, marginBottom: 30 }}>
            <RadioButton.Group
              ...
              value={selectedSize}
            >
              <Text style={{ fontWeight: 800, fontSize: 11, marginBottom: 10 }}>
                Size
              </Text>
              <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ alignItems: "center" }}>
                  ...
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "Grande", price: "+10.000" }}
                      selectedValue={selectedSize}
                      onPress={setSelectedSize}
                    />
                  </View>
            ...
            >
              <View style={styles.specifications}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "Hot", price: "free" }}
                      selectedValue={availableIn}
                      onPress={setAvailableIn}
                    />
                  </View>
            ...
            >
              ...
              <View style={styles.specifications}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "Soya Milk", price: "8.500" }}
                      selectedValue={milk}
                      onPress={setMilk}
                    />
                  </View>
              ...
              <View style={styles.specifications}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "Almond Milk", price: "19.000" }}
                      selectedValue={milk}
                      onPress={setMilk}
                    />
                  </View>
            ...
            >
              <View style={styles.specifications}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "no shots", price: "free" }}
                      selectedValue={espressoShot}
                      onPress={setEspressoShot}
                    />
                  </View>
                  <Text style={{ marginLeft: 15, fontWeight: 500 }}>
                    No Espresso Shot
              ...
              <View style={styles.specifications}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "Extra 1 Espresso Shot", price: "6.000" }}
                      selectedValue={espressoShot}
                      onPress={setEspressoShot}
                    />
                  </View>
                  <Text style={{ marginLeft: 15, fontWeight: 500 }}>
                    Extra 1 Espresso Shot
                  </Text>
                </View>
              ...
              <View style={styles.specifications}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "Extra 2 Espresso Shot", price: "12.000" }}
                      selectedValue={espressoShot}
                      onPress={setEspressoShot}
                    />
                  </View>
                  <Text style={{ marginLeft: 15, fontWeight: 500 }}>
                    Extra 2 Espresso Shot
                  </Text>
                </View>
              ...
              <View style={styles.specifications}>
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={styles.outerSquareBox}>
                    <SquareRadioButton
                      value={{ type: "Extra 3 Espresso Shot", price: "18.000" }}
                      selectedValue={espressoShot}
                      onPress={setEspressoShot}
                    />
                  </View>
                  <Text style={{ marginLeft: 15, fontWeight: 500 }}>
                    Extra 3 Espresso Shot
                  </Text>
                </View>
      ...
      <View style={styles.quantityBottomSection}>
        ...
        <View style={{ width: 120, marginTop: 18 }}>
          ...
          >
            Rp {finalPrice !== undefined ? finalPrice.toFixed(3) : "0.000"}
          </Text>
          <TouchableOpacity
