    ...
    <View style={styles.container}>
      ...
      <View style={styles.offer}>
        ...
        >
          <Image
            source={{
              uri: "https://miro.medium.com/v2/resize:fit:600/1*5ripYVfVIutphv0soKBUfg.jpeg",
            }}
            style={{
              height: 170,
              aspectRatio: "2/1",
          ...
          <Image
            source={{
              uri: "https://myvancity.ca/wp-content/uploads/2023/08/SPOT-ONE1_AUG-16_EN.jpg",
            }}
            style={{
              height: 170,
              aspectRatio: "2/1",
          ...
          <Image
            source={{
              uri: "https://media-cldnry.s-nbcnews.com/image/upload/t_fit-760w,f_auto,q_auto:best/rockcms/2023-07/50-off-cold-drinks-starbucks-zz-230726-01-7b2f9e.jpg",
            }}
            style={{
              height: 170,
              aspectRatio: "2/1",
        ...
        >
          <TouchableOpacity onPress={() => handleButtonPress("Your Favorite")}>
            <Text
              style={[
                styles.type,
                activeButton === "Your Favorite" && styles.activeText,
              ]}
            >
              Your Favorite
            </Text>
          ...
          <TouchableOpacity onPress={() => handleButtonPress("Bundling")}>
            <Text
              style={[
                styles.type,
                activeButton === "Bundling" && styles.activeText,
              ]}
            >
              Bundling
            </Text>
          ...
          <TouchableOpacity onPress={() => handleButtonPress("Beverage")}>
            <Text
              style={[
                styles.type,
                activeButton === "Beverage" && styles.activeText,
              ]}
            >
              Beverage
            </Text>
          ...
          <TouchableOpacity onPress={() => handleButtonPress("Grande Morning")}>
            <Text
              style={[
                styles.type,
                activeButton === "Grande Morning" && styles.activeText,
              ]}
            >
              Grande Morning
            </Text>
