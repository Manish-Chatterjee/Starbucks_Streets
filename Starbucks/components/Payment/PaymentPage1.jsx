...
export default function PaymentPage1({ route }) {
  ...
  // console.log("Mounted → PaymentPage1");
  ...
  return (
    <View style={styles.container}>
        ...
        >
          <Text
            style={{
              ...
              fontWeight: 600,
              textAlign: "center",
              color: selectedOption === "delivery" ? "#04643c" : "gray",
            }}
          >
            DELIVERY
          </Text>
        ...
        >
          <Text
            style={{
              ...
              fontWeight: 600,
              textAlign: "center",
              color: selectedOption === "takeAway" ? "#04643c" : "gray",
            }}
          >
            TAKE AWAY
          </Text>
      ...
      >
        ...
        <View style={styles.addressContainer}>
          <View style={{ flexDirection: "row", paddingBlock: 8 }}>
            ...
            {selectedOption === "takeAway" ? (
              <Fontisto name="coffeescript" size={16} color="#d4c495" />
            ) : null}
            <View>
              <View
                style={{
              ...
              >
                <View style={{ marginLeft: 7 }}>
                  <Text style={{ fontWeight: 700, color: "#04643c" }}>
                    Starbucks Plaza Indonesia 2
                  </Text>
                  <Text
                    style={{
                      fontSize: 10,
                  ...
                  >
                    Plaza Indonesia 4th floor, #E0231 & #E023T Jalan M.H.
        ...
        {selectedOption === "takeAway" ? (
          <View style={{ marginBlock: 10, marginInline: 10 }}>
            ...
            >
              <Text style={{ fontSize: 12, fontWeight: 700, color: "#04643c" }}>
                YOUR ORDER
              </Text>
              <Text style={{ fontSize: 12, fontWeight: 700, color: "#d4c495" }}>
                9.45 am
              </Text>
            </View>
            <Text
        ...
        <View style={{ marginBlock: 10, marginInline: 10 }}>
          ...
          >
            <Image
              source={{
                uri: "https://t3.ftcdn.net/jpg/02/98/65/92/360_F_298659202_6y0mYN6XtC8RvhJPYnmmTwEnxJKYNozJ.jpg",
              }}
              style={{ width: 70, height: 70 }}
            />
            <View>
              <Text style={{ fontWeight: 700, color: "#04643c" }}>{name}</Text>
              <Text style={{ color: "grey", fontSize: 10, fontWeight: 600 }}>
                {selectedSize.type}, {availableIn.type}, {milk.type}
              </Text>
              {espressoShot?.type !== "no shots" && (
                <Text style={{ color: "grey", fontSize: 10, fontWeight: 600 }}>
                  {espressoShot.type}
                </Text>
              )}
              <Text style={{ color: "#d4c495", fontWeight: 600, marginTop: 5 }}>
        ...
        <View style={{ marginBlock: 10, marginInline: 10 }}>
          ...
          >
            You will get 4 stars pay with Starbucks Card
          </Text>
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <View>
                ...
                <Text
                  style={{ fontSize: 12, fontWeight: 400, color: "#04643c" }}
                >
                  {/* Rp 693.000 */}
                  {selectedPayment && <Text>Rp {selectedPayment.price}</Text>}
                </Text>
          ...
          <View style={{ marginBlock: 10 }}>
            ...
            >
              <Text style={{ fontWeight: 400, fontSize: 12, color: "gray" }}>
                Price
              </Text>
              <Text style={{ fontWeight: 700, fontSize: 12, color: "#d4c495" }}>
                Rp {finalPrice.toFixed(3)}
            ...
            >
              {selectedOption === "delivery" ? (
                ...
                >
                  <Text
                    style={{ fontWeight: 400, fontSize: 12, color: "gray" }}
                  >
                    Shipping Charges
                  </Text>
                  <Text
                    style={{ fontWeight: 700, fontSize: 12, color: "#d4c495" }}
                  >
                    Rp 15.000
                  </Text>
                </View>
            ...
            >
              <Text style={{ fontWeight: 700, fontSize: 12, color: "#04643c" }}>
                Total
              </Text>
              <Text style={{ fontWeight: 700, fontSize: 12, color: "#d4c495" }}>
                Rp{" "}
                {selectedOption === "delivery"
                  ? (finalPrice + 15).toFixed(3)
      ...
      {showPaymentSuccess && (
        <PaymentSuccess onClose={handleClosePaymentSuccess} points={4} />
      )}
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Pressable
              ...
              ]} // Change opacity based on enabled state
              onPress={() => {
                if (isSubmitEnabled) {
